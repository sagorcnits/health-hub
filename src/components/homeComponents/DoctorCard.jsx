...
const DoctorCard = ({doctorInfo}) => {
  return (
    <div className="card border border-b p-4 font-Source_Sans hover:card-effect duration-500">
      <figure className="bg-[#DDDFE0] rounded-md overflow-hidden">
        <Image className="w-full"  src={doctorInfo.image}></Image>
      </figure>
      <div>
        <h3 className="text-[20px] font-Source_Sans py-2 font-semibold">{doctorInfo.name}</h3>
        <p>{doctorInfo.proffesion}</p>
        <div className="rating py-4 border-b border-[#F3F3F3] w-full">
          <input
            type="radio"
            name="rating-2"
        ...
        <button className="button-2 w-full font-semibold text-[20px]">View Profile</button>
      </div>
    </div>
  );
};
